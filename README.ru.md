...
5. Перед публичным выпуском замените шаблонные решения по управлению, контактам и лицензии на утверждённые владельцем проекта.
...
Лицензия пока не выбрана. Пока правообладатель не добавит файл `LICENSE`, этот репозиторий не предоставляет прав на повторное использование материалов.
